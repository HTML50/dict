  ...
  <iframe id="injectedResultBox" scrolling="no"></iframe>\
    ...
    document.addEventListener('mousemove', function(e) {
        if (isMouseDown) {
            ...
            if(e.clientY > window.innerHeight - parseInt(dictBox.style.height) ){
                cy= window.innerHeight -parseInt(dictBox.style.height);
            }
    ...
    document.addEventListener('mouseup', function(e) {
            ...
            if (!isBoxOpened) {
                ...
                if (selectWord != '' &&  isDragSearch && e.target.nodeName != 'DICTBOXBAR') {
                    lookup(selectWord);
                } else {
    ...
    function setHeight(){
        ...
        chrome.runtime.sendMessage({ get: "height" }, function(response) {
            ...
            if (h == 52) {
                dictBox.style.height = 142+'px';
                //injectedResultBox.src = '404.html'
            } else {
                dictBox.style.height = h+42 +'px';
            }
