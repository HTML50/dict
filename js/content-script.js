...
function init() {
  ...
  var isDragSearch, isCtrlSearch,lastWord;
  ...
  injectedHTML.style.position = 'absolute';
  ...
  document.addEventListener('mouseup', function(e) {
    ...
    if (!isBoxOpened) {
      ...
      if (selectWord != '' && lastWord!=selectWord && isDragSearch && e.target.nodeName != 'DICTBOXBAR' && e.target.nodeName != 'IMG') {
        lookup(selectWord);
      } else {
